...
class Main_game:
    def __init__(self,fps):
        ...
        self.background_hight = self.background.get_height()
        
        
        self.back_x = (self.background_width/2 - self.width/2) *-1
        self.back_y = (self.background_hight/2 - self.hight/2) *-1
        self.back_speed = 125
    ...
    def run(self):
        ...
        while running:
            ...
            if pressedkeys[pygame.K_s]:
                if self.back_y < (self.background_hight - self.hight)*-1:
                    self.back_y = (self.background_hight - self.hight)*-1
                else:
                    self.back_y -= self.back_speed * self.sec
            ...
            if pressedkeys[pygame.K_d]:
                if self.back_x < (self.background_width - self.width) *-1:
                    self.back_x = (self.background_width - self.width) *-1
                else:
                    self.back_x -= self.back_speed * self.sec
